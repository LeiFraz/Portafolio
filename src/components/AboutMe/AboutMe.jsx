import { Avatar, Box, Button, List, ListItem, ListItemIcon, Typography } from "@mui/material"
    ...
    return(
        <>
            <Box id='SobreMi' sx={{
                ...
                <Typography variant="h3" sx={{pb: '20px', fontWeight: 'bold'}}> TECNOLOGÍAS Y HERRAMIENTAS </Typography>
                <Box sx={{
                    mb: '30px',
                    // maxWidth: '700px',
                    backgroundColor: '#0B3C5D',
